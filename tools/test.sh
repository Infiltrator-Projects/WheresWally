...
printf '[1/12] Validating manifest identity and release version (%s)\n' "$VERSION"
...
echo '[11/12] Building and inspecting Debian package'
...
echo '[12/12] Checking for release-version drift in build logic'
